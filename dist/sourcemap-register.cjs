	...
	var e = {
		...
		599: (e, r, n) => {
			...
			function mapSourcePosition(e) {
				...
				if (r?.map && typeof r.map.originalPositionFor === "function") {
		...
		684: (_e, r, n) => {
			...
			SourceMapConsumer.prototype._parseMappings =
				function SourceMapConsumer_parseMappings(_e, _r) {
			...
			BasicSourceMapConsumer.prototype._parseMappings =
				function SourceMapConsumer_parseMappings(e, _r) {
					var n = 1;
					var t = 0;
					var i = 0;
					var a = 0;
			...
			IndexedSourceMapConsumer.prototype._parseMappings =
				function IndexedSourceMapConsumer_parseMappings(_e, _r) {
		...
		565: (_e, _r, _n) => {
			...
			SourceNode.fromStringWithSourceMap =
				function SourceNode_fromStringWithSourceMap(e, _r, n) {
