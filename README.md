...
| `strict-compatibility`  | `false`                               | Whether to fail when the compose spec uses Swarm-incompatible features that can't be translated. See [reconciliation](#compose--swarm-reconciliation). |
